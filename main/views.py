...
class HeaderAPIView(APIView):
    def get(self, request, lang=None):
        ...
        projects_headerSR = ProjectHeaderSerializer(projects_header, context={'lang': lang})
        ps_header = PSHeader.objects.first()
        problems = Problem.objects.all()
        solutions = Solution.objects.all()
        ps_headerSr = PSHeaderSerializer(ps_header, context={'lang': lang})
        ...
        services_headerSR = ServicesHeaderSerializer(services_header, context={'lang': lang})

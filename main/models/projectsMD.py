...
class Project(models.Model):
    title_uz = RichTextField(verbose_name="project title uz")
    ...
    subtitle_uz = RichTextField(verbose_name="project subtitle uz")
    ...
    description_uz = RichTextField(verbose_name="project description uz")
